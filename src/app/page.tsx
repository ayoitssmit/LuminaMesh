...
function LandingContent() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (signInRes?.error) {
      ...
      // Redirect to onboarding to set username, preserving callbackUrl
      const onboardingUrl = callbackUrl && callbackUrl !== "/dashboard" 
    ...
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        {tab === "login" ? (
          ...
          <form className={styles.form} onSubmit={handleSignup} style={{ marginTop: '2rem' }}>
            <input
              className={styles.input}
              type="email"
